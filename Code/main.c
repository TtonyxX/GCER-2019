...
#define claw_open_firetruck 550
...
int main(){
    ...
    turn_right90();
    msleep(500);
    slow_servo(claw, claw_open_medical); //grabs medical supplies 
    ...
    if(burning_building == 1){
        ...
        move(1500, 800, change); //moves forward to burning building 
        move(-1500, 40, change); 
        msleep(500);
        turn_left90(); 
        msleep(500);
